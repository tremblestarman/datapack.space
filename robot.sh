...
do
    ...
    cd "$parent_path"
    mysqldump -uroot -p\"$MYSQLPASSWORD\" datapack_collection -P 3306 datapacks tags authors datapack_tags datapacks_related authors_related datapacks_log datapacks_ii_queue > "$parent_path"/datapack_collection.sql
